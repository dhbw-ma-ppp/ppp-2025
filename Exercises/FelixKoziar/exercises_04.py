...
# other tests:
#simulate_virtual_machine(test1) -> outputs 0 if input !=8 else 1
#simulate_virtual_machine(test2) -> outputs 0 if input >=8 else 1
# simulate_virtual_machine(test3) -> outputs 0 if input !=0 else 1
