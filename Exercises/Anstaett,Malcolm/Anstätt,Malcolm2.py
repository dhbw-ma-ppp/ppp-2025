    ...
    while i < len(lst):
        match lst[i]:
            ...
            case 2:
                ...
                i = i + 4
            case 99:
                print("Der Wert an Stelle i = 0 beträgt",lst[0],"\n")
                break
            case _:
...
def string_sort(*args):
    ...
    for arb_string in args:
        try:
                float(arb_string)
                number_lst.append(arb_string)
        except ValueError:
                if arb_string.lower() == "pi":
                    number_lst.append("pi")
                elif arb_string.lower() == "e":
                    number_lst.append("e")
                else:
                    pass
        if len(arb_string) == 1:
            string_lst.append(arb_string)
        else:
